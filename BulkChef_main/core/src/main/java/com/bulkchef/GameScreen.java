...
public class GameScreen implements Screen {
    ...
    public void show() {
        ...
        interactions.put("treadmill",  new Interaction("Run",   Interaction.Type.EX_LOWER,  -100f, 0, 0,  15f, 20f));
        interactions.put("benchpress", new Interaction("Bench", Interaction.Type.EX_UPPER,  -100f, 0, 20f, 0,  25f));
        interactions.put("cycling",    new Interaction("Ride",  Interaction.Type.EX_LOWER,  -150f, 0, 0,  12f, 18f));
        interactions.put("dumbell",    new Interaction("Lift",  Interaction.Type.EX_UPPER,  -180f, 0, 18f, 0,  22f));
